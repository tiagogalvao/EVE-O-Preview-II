...
namespace EveOPreview.View.Implementation
{
    public partial class ThumbnailOverlay : Form
    {
        ...
        private void OverlayArea_Click(object sender, MouseEventArgs e) => _areaClickAction(this, e);

        public void SetOverlayLabel(string label) => OverlayLabel.Text = label;

        public void EnableOverlayLabel(bool enable) => OverlayLabel.Visible = enable;
